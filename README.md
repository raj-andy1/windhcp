...
1. [Setup - The basics of getting started with windhcp](#setup)
    * [What windhcp affects](#what-windhcp-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with windhcp](#beginning-with-windhcp)
